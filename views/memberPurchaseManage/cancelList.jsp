							...
							<div class="right">
								<div class="right_tit">
									<div class="rt_tit clear">
										<h4 class="off" onclick="location.href='/member/purchase/list'">구매내역 조회</h4>
										<h4>취소내역 조회</h4>
									</div>
									<div class="search_wrap">
										...
										<div class="row">
											...
											<div class="td">
												...
												<div class="comm_txt">
													<input type="text" class="w_300" id="searchString" name="searchString" value="${hMap.searchString}"/>
												</div>
												<div class="btn_sch_s">
										...
										<div class="row">
											...
											<div class="td">
												...
												<div class="comm_chk">
													<label><input type="checkbox"><span>보험여부</span></label>
												</div>
											</div>
										</div>
											<input hidden id="insureCodeYn" name="insureCodeYn" value="N">
										</form>
									</div>
								<div class="right_txt">
									<div class="rt_cnt">
										<div class="comm_ctrl_bar">
											<div class="cnt_wrap">
												<ul>
													...
													<li>
														<div>결제 금액 : <span class="num"><fmt:formatNumber value="${sum.total_amount}" pattern="#,###" /></span>원</div>
													</li>
												</ul>
											</div>
											<div class="btn_wrap">
