		...
		<script type="text/javascript">
			...
			$(document).ready(function (){
				...
				$("#hidden_link").on("click",function(){
	        		var offset = $($(this).data('value')).offset();
	        		// console.log(offset.top);	        				
	                $('html, body').animate({scrollTop : (offset.top-300)}, 700);
				});
		...
		<section id="searchMain" class="sub">
			<article class="cnt1" id="cnt_anchor">
				<div class="banner_wrap">
					<img src="/resources/images/sub/img_compareprice_slide01.jpg?v20220114" />
				</div>
				<div class="area">
								...
								<ul class="depth1">
									<li class="filter_1">
										<div class="filter_tit clear">
											<h4>카테고리</h4><a id="hidden_link" data-value="아나" href="javascript:;"></a>
...
<!-- 														<button class="buy_btn lb" id="btn_buy" type="button">구매하기</button> -->
		 ...
		 <script type="text/javascript">
		 	$(function() {
				...
				$("#hidden_link").data("value", "#" + link[1]);									        	
	        	$("#hidden_link").get(0).click();	        	      	
	       });
	       </script>
	</jsp:body>
</layout:basicFrame>