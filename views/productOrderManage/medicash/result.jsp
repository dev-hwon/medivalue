	...
	<jsp:attribute name="javascript">
		...
		<script type="text/javascript">
			$(document).ready(function (){
				// purchase_log();
				<%--ad_log_naver("1", "${productOrderResult.fd_total_payment}");--%>
			...
			<%--	let productOrderResultJson = JSON.parse('${productOrderResultJson}');--%>
			<%--	let productInfoListJson = JSON.parse('${productInfoListJson}');--%>
