...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            setEventProduct(version, productList);
            ...
            <main>
                <section>
                    <article class="atc_aside">
                        ...
                        <div class="tab_wrap">
                            <div class="title"><span><a class="version-title" href="javascript:void(0)">FR.1</a></span></div>
                            <ul class="version-list" style="display:none">
                                <li class="FR"><a href="/survey/event/FR">FR.1</a></li>
                                <li class="SA1"><a href="/survey/event/SA1">SA.1</a></li>
                                <li class="SA2"><a href="/survey/event/SA2">SA.2</a></li>
                                <li class="SU1"><a href="/survey/event/SU1">SU.1</a></li>
                                <li class="SU2"><a href="/survey/event/SU2">SU.2</a></li>
                            </ul>
                        </div>
                        <div class="btn_wrap">
