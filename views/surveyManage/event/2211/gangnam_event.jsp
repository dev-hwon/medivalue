            ...
            <main>
                <section>
                    <article class="atc_aside">
                        <div class="inner">
                            <div class="head">
                                <div class="title2">100% 당첨<br>뽑기게임</div>
                            </div>
                            <div class="body">
                                        ...
                                        <li>
                                            <div>
                                                <div class="img">
                                                    ...
                                                    <%--
                                                    <div class="badge">8명</div>
                                                     --%>
                                                </div>
                                                <div class="txt">
                                                    <div class="tit">신세계</div>
                                                    <div class="desc">신세계 상품권 5만원</div>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div>
                                                <div class="img">
                                                    ...
                                                    <%--
                                                    <div class="badge">46명</div>
                                                     --%>
                                                </div>
                                                <div class="txt">
                                                    <div class="tit">MBX</div>
                                                    <div class="desc">아이듀케어 비타민 투 글로우 팩</div>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
