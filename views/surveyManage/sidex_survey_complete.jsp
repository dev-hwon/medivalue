...
<head>
    ...
    <meta http-equiv="refresh" content="20;URL='/survey/login'">
                ...
                <section class="sec_intro">
                    <article>
                        <div class="inner">
                            ...
                            <div class="txt_wrap">
                                설문 완료를 직원에게 말씀해 주시면<br>100% 경품 당첨 이벤트 안내를 받으실 수 있습니다.
                            </div>
                            <div class="desc_wrap">
                                지금까지 IT 기술력으로 의료 환경을 혁신하는 메디밸류 AI 어시스턴트였습니다.<br>설문에 응답해 주셔서 감사합니다 :)
                            </div>
                        </div>
                    </article>
                </section>
