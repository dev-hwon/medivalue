...
<script type="text/javascript">
	...
	$(function () {
        ...
        if (rtn_code > 500) {
            if (errCd > 0) {
                // opener.signInPopup.showMessage(resultMsg + " " + "에러코드(" + errCd + ")");
                alert(resultMsg + " " + "에러코드(" + errCd + ")");
            } else {
                // opener.signInPopup.showMessage(rtn_msg);
                alert(rtn_msg);
            }
            alert(rtn_msg);
        } else {
            // opener.signInPopup.showMessage("간편현금결제를 취소하셨습니다.");
            alert("간편현금결제를 취소하셨습니다.");
        }
