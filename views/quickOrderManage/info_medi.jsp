...
<layout:basicFrameNew>
	...
	<jsp:attribute name="javascript">
		...
		<script type="text/javascript" src="/resources/js/common.js?v=20220317"></script>
		<%--
                        ...
                        if (data["rtn_code"] === "200") {
                            ...
                            if (cart_list != null && cart_list.length > 0) {
                                ...
                                cart_list.forEach(function (value, index) {
                                    ...
                                    dy_cart_html +="<label class=\"label_check\"><input type=\"checkbox\" id=\"pd_order_chk\" name=\"pd_order_chk\" class=\"chk_cart chk_cart_list\">";
                                    dy_cart_html +="<div>";
                                                            	...
                                                            	<c:if test="${!empty cart_list}">
                                                            		<c:forEach var="item" items="${cart_list}" varStatus="status">
                                                            			...
                                                            			<div class="tr insure special">
		                                                                    <div class="text">
		                                                                        <div class="title">
		                                                                            <label class="label_check g_q_t5_product_check"><input type="checkbox" id="pd_order_chk" name="pd_order_chk" class="chk_cart chk_cart_list" value="Y">
		                                                                            	<div>
		                                                                            		<div class="badge">
                                                    ...
                                                    <div class="comm_tab_wrap">
	                                                    <ul class="radio_wrap point_radio_wrap flex_start radio_button_wrap">
                                                            <li>
                                                                ...
                                                                <div class="label_radio_tooltip tooltip_m_point">
                                                                    메디캐시 결제시 2% 적립
                                                                </div>
                                                            </li>
                                                            <li>
                                            ...
                                            <div class="paymentTypeDiv">
	                                            ...
	                                            <div class="order_body">
	                                                <div class="order_basic">
	                                                    <div class="radio_wrap payment_radio_wrap flex_start">
	                                                    	<label class="label_radio">
																<input type="radio" name="rdo_payment" value="medicash" ><span>메디캐쉬</span>
															</label>
                                                                ...
                                                                <li class="payment_detail_medicash">
                                                                    <div>
                                                                            ...
                                                                            <dd>
                                                                                <div class="row flex_end">
                                                                                    <div class="text word_keep">
                                                                                        <span class="color_orange" id="user_medicash_info" data-user-medicash="${m_cash.fd_total_amount}"><fmt:formatNumber value="${m_cash.fd_total_amount}" pattern="#,###" /></span> 원
                                                                                    </div>
                                                                        ...
                                                                        <dl>
                                                                            ...
                                                                            <dd>
                                                                                <div class="row">
                                                                                    <input type="number" class="inp_basic" id="medicash_use_amount" name="medicash_use_amount" value="0" min="0"/>
                                                                    ...
                                                                    <div class="payment_tip">
                                                                        ...
                                                                        <label class="label_check_2 input_checkbox_payment_repeat">
                                                                            <input type="checkbox" id="payment_repeat" name="payment_repeat" value="Y" <c:if test="${payment_type eq 'medicash' }">checked="checked"</c:if>/><span>다음에도 이 결제수단을 사용합니다.</span>
