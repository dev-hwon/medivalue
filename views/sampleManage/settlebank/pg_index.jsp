...
<script type="text/javascript" src="${PAYMENT_SERVER}/resources/js/SettlePG.js"></script>
...
function pay(type){
    ...
    var formData = $("#STPG_payForm").serialize();
    $.ajax({
        url : "/test/settlebank/pg_encryptParam",
        type : 'post',
        cache : false,
        data : formData,
        dataType : 'json',
...
<body>
<div class="wrapper">  
    <form id="STPG_payForm" name="STPG_payForm" action="" method="post" >
        <!-- 승인 요청 파라미터(필수) -->
        ...
        <input type="hidden" name="notiUrl" value="http://127.0.0.1:10001/settlebank/receiveNoti" />         <!-- 결과처리 URL -->
        <input type="hidden" name="nextUrl" value="http://127.0.0.1:10001/test/settlebank/pay_receiveResult" />   <!-- 결과화면 URL -->
        <input type="hidden" name="cancUrl" value="http://127.0.0.1:10001/test/settlebank/pay_receiveResult" />   <!-- 결제취소 URL -->
        ...
        <input type="hidden" name="plainEmail" value="test@test.test" />        <!-- 이메일주소(평문) -->
        <input type="hidden" name="telecomCd" value="" />                       <!-- 통신사코드 -->
        <input type="hidden" name="prdtTerm" value="20211231235959" />          <!-- 상품제공기간 -->
        ...
        <div class="content">
            ...
            <input type="button" class="payBtn" value="010가상계좌" onclick="pay('vbank010')" style="width:99%;"/>
             --%>
        </div>
    </form>
</div>
...
<div class="wrapper">  
    <form id="STPG_payForm2" name="STPG_payForm2" >
        ...
        <!-- 결제 요청 파라미터(Header) -->
        <input type="hidden" name="ver" value="0A17" />                     <!-- 버전(0A**, **:메뉴얼버전) -->
        ...
        <input type="hidden" name="trdAmt" maxlength="9" value="300" /> <!-- 거래금액 -->
        <input type="hidden" name="telCo" value="SKT" />                <!-- 통신사 -->
        <input type="hidden" name="email" value="test@test.test" />     <!-- 상점고객이메일 -->
