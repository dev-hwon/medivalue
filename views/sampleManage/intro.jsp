	...
	<jsp:attribute name="javascript">
		...
		<script type="text/javascript">
			...
			function atcClassOn(){
				...
				var atcVideoH = $(".atc_video").height();
				
				var atcStoreY = $(".atc_store").offset().top;
				var atcStoreH = $(".atc_store").height();
				
				var atcManageY = $(".atc_management").offset().top;
				var atcManageH = $(".atc_management").height();
				
				var atcNeedsY = $(".atc_needs").offset().top;
				var atcNeedsH = $(".atc_needs").height();
				
				var atcFunctionY = $(".atc_function").offset().top;
				var atcFunctionH = $(".atc_function").height();
				
				var atcQnaY = $(".atc_qna").offset().top;
				var atcQnaH = $(".atc_qna").height();
				
				var atcLinkY = $(".atc_link").offset().top;
				var atcLinkH = $(".atc_link").height();
	...
	<jsp:body>
		...
		<section id="intro" class="sub">
			<article class="atc_video">
				...
				<div class="text">
					<div class="desc">처음 선보이는 가격 비교<br>의료 커머스 플랫폼</div>
						...
						<ul>
							...
							<li>
								<div>
									...
									<div class="txt">
										<p class="tit">가격 비교 플랫폼</p>
										<p class="desc">의료재료 실시간 가격비교와<br>최저가 구매 스토어 제공</p>
									</div>
								</div>
							</li>
							<li>
								<div>
									...
									<div class="txt">
										<p class="tit">A/S 통합 채널</p>
										<p class="desc">치과 장비<br>직, 간접 A/S 제공</p>
									</div>
								</div>
							</li>
							<li>
								<div>
									...
									<div class="txt">
										<p class="tit">구매 자동화 솔루션</p>
										<p class="desc">인공지능을 통한<br>구매 자동화 솔루션 제공</p>
									</div>
								</div>
							</li>
						</ul>
			...
			<article class="atc_management">
				<div class="text">
					<div class="title">최고의 전문가들이 만든 의료 커머스 플랫폼</div>
					<div class="desc">
						타사에서도 메디밸류와 같은 최신 의료 커머스 플랫폼을 개발하려고 노력했지만<br>기술적 기능 구현이 불가하여 중도 포기했습니다. 하지만 메디밸류는 가능했습니다.
					</div>
				</div>
				<div class="inner">
					<div class="ceo">
						...
						<div class="history">서울과학고, D.D.S.</div>
					</div>
					<div class="manage_list col4 sty1">
						<ul>
							...
							<li>
								<div>
									<div class="name">
										<span class="tit">김건우</span>
										<span class="sub">CFO</span>
									</div>
									<div class="history">Marquette Univ. MA</div>
									<div class="desc">더 나은 의료환경을 위한 선택과<br>경험을 제안할 수 있도록 하겠습니다.</div>
								</div>
							</li>
						</ul>
					</div>
					<div class="manage_list col3 sty2">
						<ul>
							<li>
								<div>
									<div class="name">
							...
							<li>
								<div>
									<div class="name">
										<span class="tit">김형식</span>
										<span class="sub">Advisor</span>
									</div>
									<div class="history">서울과학고, QRAFT Corp. CEO</div>
								</div>
							</li>
							<li>
								<div>
									<div class="name">
										<span class="tit">김현승</span>
										<span class="sub">Advisor</span>
									</div>
									<div class="history">서울과학고, BainCapital<br>Executive Vice President</div>
								</div>
							</li>
						</ul>
					</div>
