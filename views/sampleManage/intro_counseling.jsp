		...
		<section id="intro_counseling" class="sub">
	        <article class="atc_visual">
	            ...
	            <div class="inner">
	                ...
	                <div class="image">
	                    ...
	                    <div class="img_02"><img src="/resources/images/intro_counseling/img_visual_02.png" alt=""></div>
	                </div>
	            </div>
	        </article>
	            ...
	            <div class="inner">
	                ...
	                <div class="content">
	                    <div class="text">
	                        ...
	                        <div class="desc">메디밸류의 재료전문가는 20년 이상 의료재료전문 베태랑입니다.<br>검증된 자격과 실무 능력으로 재료에 대한 전문지식을 가지고<br>전문가들이 직접 상담을 진행합니다. 재료에 대한 다양한 질문을<br>메디밸류 채팅을 통해서 물어보세요!</div>
	                    </div>
	                    <div class="image">
	        ...
	        <article class="atc_howtouse">
	            <div class="inner">
	                ...
	                <div class="atc_subtitle">채널톡으로 쉽고 간단하게 전문가와 상담하세요.</div>
	                <div class="content">
	                    <div class="tab">
	                        <ul>
	                            <li>
	                                <div>
	                                    ...
	                                    <div class="txt">
	                                        <div class="box">
	                                            <div class="box_txt">
	                                                <div class="title">채널톡 클릭</div>
	                                                <div class="desc">홈페이지 하단 우측에 채널톡<br>아이콘을 클릭해주세요.</div>
	                                            </div>
	                                        </div>
	                                    </div>
	                                </div>
	                        ...
	                        <ul>
	                            <li>
	                                <div>
	                                    ...
	                                    <div class="img">
	                                        <img src="/resources/images/intro_counseling/img_howto_02.png" alt="">
	                                        <div class="chat">
	                                            <img src="/resources/images/intro_counseling/img_howto_02_01.png" alt="" class="img_chat_01">
	                                            <img src="/resources/images/intro_counseling/img_howto_02_02.png" alt="" class="img_chat_02">
	                                            <img src="/resources/images/intro_counseling/img_howto_02_03.png" alt="" class="img_chat_03">
	                                            <img src="/resources/images/intro_counseling/img_howto_02_04.png" alt="" class="img_chat_04">
	                                            <img src="/resources/images/intro_counseling/img_howto_02_05.png" alt="" class="img_chat_05">
	                                            <img src="/resources/images/intro_counseling/img_howto_02_06.png" alt="" class="img_chat_06">
	                                        </div>
	                                    </div>
	                                </div>
	                            </li>
	                            <!-- <li>
	                                <div>
	                                    ...
	                                    <div class="img">
	                                        <img src="/resources/images/intro_counseling/img_howto_02_01.png" alt="">
	                                    </div>
	                                </div>
	                            </li>
	                            <li>
	                                <div>
	                                    ...
	                                    <div class="img">
	                                        <img src="/resources/images/intro_counseling/img_howto_02_02.png" alt="">
	                                    </div>
	                                </div>
	                            </li> -->
	                        </ul>
