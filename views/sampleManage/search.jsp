...
<layout:basicFrame>
	...
	<jsp:attribute name="javascript">
		...
		<script type="text/javascript">
			$(function(){
				$(".btn_wrap .cart_btn").click(function(){
								...
								<div class="pd_list_txt">
									...
									<ul class="depth1">
										<li class="clear">
											...
											<div class="price_info price_new">
												<h5>가격비교
													<div class="switch_wrap">
														<input type="checkbox" name="" value="" onclick="">
													</div>
												</h5>
									...
									<ul class="depth1">
												...
												<div class="price_new_comp">
													<ul class="depth2">
														<li class="low_price">
															<button class="clear">
																<h6>eDENT</h6>
																<div class="p_wrap"><p>1,062,100원</p></div>
															</button>
														</li>
														...
														<li>
															<button class="clear">
																<h6>DVmall</h6>
																<div class="p_wrap"><p>68,100원</p></div>
															</button>
														</li>
														...
														<li>
															<button class="clear">
																<h6>SellGlobal</h6>
																<div class="p_wrap"><p>90,000원</p></div>
															</button>
														</li>
													</ul>
												</div>
										...
										<li class="clear">
											...
											<div class="price_new">
												...
												<div class="price_new_comp">
													<div class="empty">가격비교할 제품이 없습니다.</div>
													
												</div>
											</div>
										</li>
										<li class="clear option">
											<div class="img">
												<div class="icon_list">
													<div class="li li_option">
														<div>
