...
<layout:basicFrame>
	...
	<jsp:attribute name="javascript">
		...
		<script src="/resources/js/bxhis.js"></script>
									...
									<ul>
										<li>
											...
											<div class="total_name clear">
												<p>[치예원] TITAN X (타이탄엑스) 0.1g  Bone substitute 1팩 일반배송 123456789 [치예원] TITAN X (타이탄엑스) 0.1g  Bone substitute 1팩 일반배송 123456789 [치예원] TITAN X (타이탄엑스) 0.1g  Bone substitute 1팩 일반배송 12345678 91234567891234567 8912345 6789</p>
											</div>
							...
							<div class="detail_info">
								<div class="info_split" id="tab1">
									...
									<div class="info_cnt info_cnt_sp">
										<div class="info_cnt_normal">
											<div class="info_cnt_top">
												<ul>
													<li class="clear">
														<h4>제품명</h4>
														<p>일이삼사오육칠팔구십일이삼사일이삼사오육칠팔구십일이삼사오일이삼사일이삼사오육칠팔구십일이삼사일이삼사오육칠팔구십일이삼사오일이삼사오육칠팔구십일이삼사오일이삼사</p>
													</li>
											...
											<div class="info_cnt_btm">
												...
												<ul>
													<li class="clear">
														<h5>제조사/수입사</h5>
														<p>내용을 입력하세요 내용을 입력하세요 내용을 입력하세요 내용을 입력하세요 입력하세요 입력하세요</p>
													</li>
										...
										<div class="info_cnt1">
											<div class="detail_info1">
												<ul class="depth1">
													<li class="depth1_li1" id="tg1">
														<h5>제조, 수출 10년 노하우의 집약체!</h5>
														<h4>TITAN X<br>타이탄엑스</h4>
														<div class="img"><img src="/resources/images/sub/sub_pdpage_img1.png" width="644" height="413" border="0" alt="" /></div>
														<p>타이탄 X는 MICRO, NANO단위의 기공이 많으며 이로인해 표면적이 증가하여 세포들이 잘 부착하고 혈액 속 성장인자들이 침투하여 골세포가 성장할 수 있는 환경을 조성합니다.</p>
													</li>
													
													<li class="depth1_li2" id="tg2">
														<h5>#타이탄엑스 #안전성 #인증</h5>
														<p>청정지역 Australia의 의료용으로 출하되는 160kg의 송아지에서<br>단 1Kg만 얻을 수 있는 순수 Cancellous만을 사용하고 있습니다.</p>
														<div class="video"></div>
														
														<ul class="depth2 clear">
															<li><p>•전 세계적으로 안전성이 인증된 원재료 사용</p></li>
															<li><p>•면역반응을 일으키는 단백질 99%제거</p></li>
															<li><p>•이식부위에 신생골 형성과 성장 촉진</p></li>
															<li><p>•엄격하고 까다로운 FDA, CE인증</p></li>
															<li><p>•Human Bone과 유사 구조로 상체적합성 골이식재</p></li>
															<li><p>•유럽에서 인정하고 수출하는 BONE</p></li>
															<li><p>•10년 이상 축적된 임상 데이타</p></li>
															<li><p>•손 쉬운 조작성</p></li>
														</ul>
													</li>
													
													<li class="depth1_li3" id="tg3">
														<div class="features_wrap">
															<h5>TITAN-X 특장점</h5>
															
															<ul class="depth2">
																<li class="dp2_li1 clear">
																	<div class="features_left">
																		<div class="img"><img src="/resources/images/sub/sub_pdpage_img2.png" width="297" height="100" border="0" alt="" /></div>
																		<p>•높은 다공 구조와 넓은 내부표면적</p>
																		<p>•사람의 골과 가장 유사한 구조</p>
																	</div>
															
																	<div class="features_right">
																		<div class="img"><img src="/resources/images/sub/sub_pdpage_img3.png" width="150" height="100" border="0" alt="" /></div>
																		<p>•g당 부피가 타사보다 월등히 뛰어남</p>
																	</div>
																</li>
															
																<li class="dp2_li2 clear">
																	<div class="features_left">
																		<div class="img"><img src="/resources/images/sub/sub_pdpage_img4.png" width="298" height="70" border="0" alt="" /></div>
																		<p>•저온 처리로 단백질을 제거</p>
																		<p>•유리화 현상을 최소화</p>
																	</div>
															
																	<div class="features_right">
																		<div class="img"><img src="/resources/images/sub/sub_pdpage_img5.png" width="150" height="100" border="0" alt="" /></div>
																		<p>•골전도가 높은 표면</p>
																	</div>
																</li>
															</ul>
														...
														<div class="features_wrap" style="margin-top:100px">
															<h5>TITAN-X 특장점</h5>
											...
											<button class="full_view">상세정보 더보기<img src="/resources/images/main/sub_view_btn.png" width="14" height="9" border="0" alt="" /></button>
										</div>
									</div>
								</div>
							</div>
