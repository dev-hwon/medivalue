            ...
            <main>
                ...
                <section class="sec_intro">
                    <article>
                        <div class="inner">
                            <div class="img_wrap">
                                <a href="/sample/sidex_survey_login"><img src="/resources/images/sidex_survey/ico_logo.png" alt="medivalue"></a>
                            </div>
                            <div class="btn_wrap">
                                <div class="desc">설문 참여하고 100% 당첨 이벤트에서 경품 받아 가세요!</div>
                                <a href="/sample/sidex_survey_main" class="btn_start" >30초 설문 시작하기</a>
