							...
							<div class="right">
								<div class="right_tit">
									<div class="rt_tit clear">
										...
										<div class="util">
                                            <div class="info">
                                                포인트 조회기간 안내 <a href="javascript:;">i<span class="info_box">OK캐쉬백 포인트 조회는 최대 6개월 가능합니다.</span></a>
                                            </div>
                                        </div>
									</div>
								</div>
										...
										<div class="rc1_btm">
											...
											<div class="info_list">
												<ul>
													...
													<li>부분취소가 발생할 경우, 전체 적립 취소 후 실결제금액만큼 재적립됩니다.</li>
