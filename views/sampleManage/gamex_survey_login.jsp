            ...
            <main>
                <section class="sec_intro">
                    <article>
                        <div class="inner">
                            <div class="img_wrap">
                                <a href="/sample/gamex_survey_login"><img src="/resources/images/gamex_survey/ico_logo.png" alt="medivalue"></a>
                            </div>
                            <div class="ques_wrap">
                                <div class="img">
                            ...
                            <div class="btn_wrap">
                                ...
                                <a href="/sample/gamex_survey_main" class="btn_start" >30초 만에 끝내는 설문 시작하기</a>
                            </div>
