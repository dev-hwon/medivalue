    ...
    <div id="wrap">
    	<header>
    		<div class="inner">
    			...
    			<div class="share">
    				<a href="javascript:;" data-clipboard-text="https://www.medivalue.co.kr/event/dental1" class="btn_share"><img src="/resources/images/pre_reservation/ico_share.png" alt="" /></a>
    			</div>
    		</div>
    	</header>
        <div id="container" class="main dental">
            <main>
                			...
                			<div class="input">
                				<ul>
                					...
                					<li>
                						...
                						<input type="hidden" name="req_time" id="req_time" value="C1">
                					</li>
                				</ul>
                			</div>
                			<div class="agree">
