...
<layout:basicFrame>
	...
	<jsp:body>
		<section id="event_promotion" class="sub">
            ...
            <article class="atc_benefit_01" id="atc_benefit_01">
	            <div class="inner">
	            	<div class="atc_text">
	            		<div class="tit">메이저 6개 회사 제품 한정</div>
	            		<div class="desc">(3M/ 3M Espe / 3M Unitek / Dentsply Sirona / Dentsply Mailefer / GC)</div>
	            	</div>
                                ...
                                <c:if test="${!empty event_list}">
                                    ...
                                    <div>
                                        <a href="javascript:;">
                                            ...
                                            <div class="txt">
                                                <div class="price">
                                                    <div class="prime"><fmt:formatNumber value="${item.tpsm_product_amount}"/>원</div>                                                    
                                                    <div class="discount">
                                                    	<fmt:parseNumber var="temp_view_amount" value="${item.tpsm_product_amount-((item.tpsm_product_amount-item.tpsm_product_discount_amount)+(item.tpsm_product_amount*0.05))}" integerOnly="true" />
                                                    	<fmt:formatNumber value="${temp_view_amount}"/>원
                                                    </div>
                                                </div>
